...
module StateSizedIO.writingOOsUsingIOVers2 where
...
callMethod' : {I₁ : IOInterfaceˢ }{I₂ :  IOInterfaceˢ}
             ...
             {s₂ : I₂ .IOStateˢ}
             (c : Commandˢ I₂ s₂) →
             ((r : Responseˢ I₂ s₂ c) → IOˢind I₂ (IOˢindcoindShape I₁ I₂ ∞ A s₁) (IOnextˢ I₂ s₂ c r))
             → IOˢindcoind _ _ (↑ ∞) (λ v v₁ → _) _ _
callMethod' {I₁}{I₂}{A}{s₁}{s₂} c f =  delayˢic {I₁} {I₂}{∞} {A}{s₁}{s₂}
                                       (callMethod {I₂} {IOˢindcoindShape I₁ I₂ ∞ A s₁} {s₂} c f)
